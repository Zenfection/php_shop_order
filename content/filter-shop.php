        ...
        <div class="shop-top-show">
            ...
            if (isset($_POST['search_filter'])) {
                ...
                $sql = "SELECT * FROM `tb_product` 
                            ...
                            LIKE CONCAT('%', LOWER(CONVERT('$search_filter', BINARY)), '%')";
            } else if (isset($_POST['category_filter'])) {
                $category_filter = $_POST['category_filter'];
                if ($category_filter == "all") {
                    $sql = "SELECT * FROM `tb_product`";
                } else {
                    $sql = "SELECT * 
                                FROM `tb_category` as c, `tb_product` as p
                                WHERE c.id_category = p.id_category 
                                AND p.id_category = '$category_filter'";
                }
